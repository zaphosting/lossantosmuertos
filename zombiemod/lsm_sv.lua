...
local function add_wanted_trade(price,item,amount)
	local returned_table={}
	returned_table.selling="cash"
	returned_table.minhowmuch=price*0.5
	returned_table.maxhowmuch=price*1.5
	returned_table.itemforbuying=item
	if amount==1 or amount==nil then
		returned_table.minprice=1
		returned_table.maxprice=1
	else
		returned_table.minprice=amount*0.5
		returned_table.maxprice=amount*1.5
	end
	return returned_table
end
--MAKE IT SO IF FACTION SELLS SOMETHING, IT CANT BUY IT FOR MORE MONEY
trades.buying={}
trades.buying={
	add_wanted_trade(40,"jerrycan"),
	add_wanted_trade(50,"hatchet"),
	add_wanted_trade(50,"golfclub"),
	add_wanted_trade(50,"switchblade"),
	add_wanted_trade(50,"knife"),
	add_wanted_trade(50,"dagger"),
	add_wanted_trade(50,"bat"),
	add_wanted_trade(50,"battleaxe"),
	add_wanted_trade(50,"crowbar"),
	add_wanted_trade(100,"flashlight"),
	add_wanted_trade(50,"knuckle"),
	add_wanted_trade(50,"machete"),
	add_wanted_trade(50,"wrench"),
	add_wanted_trade(50,"poolcue"),
	add_wanted_trade(80,"molotov"),
	add_wanted_trade(130,"pipebomb"),
	add_wanted_trade(150,"flaregun"),
	add_wanted_trade(100,"ball"),
	add_wanted_trade(200,"snspistol"),
	add_wanted_trade(230,"vintagepistol"),
	add_wanted_trade(270,"pistol"),
	add_wanted_trade(300,"combatpistol"),
	add_wanted_trade(400,"doubleaction"),
	add_wanted_trade(400,"revolver"),
	add_wanted_trade(2000,"appistol"),
	add_wanted_trade(1000,"heavypistol"),
	add_wanted_trade(600,"marksmanpistol"),
	add_wanted_trade(2000,"pistol50"),
	add_wanted_trade(1600,"pistol_mk2"),
	add_wanted_trade(2500,"revolver_mk2"),
	add_wanted_trade(300,"dbshotgun"),
	add_wanted_trade(450,"musket"),
	add_wanted_trade(2500,"assaultshotgun"),
	add_wanted_trade(1500,"bullpupshotgun"),
	add_wanted_trade(1000,"heavyshotgun"),
	add_wanted_trade(500,"pumpshotgun"),
	add_wanted_trade(1500,"pumpshotgun_mk2"),
	add_wanted_trade(800,"snspistol_mk2"),
	add_wanted_trade(500,"sawnoffshotgun"),
	add_wanted_trade(1700,"autoshotgun"),
	add_wanted_trade(1300,"assaultsmg"),
	add_wanted_trade(1500,"combatmg"),
	add_wanted_trade(2500,"combatmg_mk2"),
	add_wanted_trade(1900,"combatpdw"),
	add_wanted_trade(2100,"gusenberg"),
	add_wanted_trade(350,"machinepistol"),
	add_wanted_trade(900,"mg"),
	add_wanted_trade(500,"microsmg"),
	add_wanted_trade(700,"minismg"),
	add_wanted_trade(450,"smg"),
	add_wanted_trade(1400,"smg_mk2"),
	add_wanted_trade(1200,"advancedrifle"),
	add_wanted_trade(200,"rocket"),
	add_wanted_trade(600,"assaultrifle"),
	add_wanted_trade(2000,"assaultrifle_mk2"),
	add_wanted_trade(800,"bullpuprifle"),
	add_wanted_trade(2000,"bullpuprifle_mk2"),
	add_wanted_trade(1000,"carbinerifle"),
	add_wanted_trade(2500,"carbinerifle_mk2"),
	add_wanted_trade(550,"compactrifle"),
	add_wanted_trade(1200,"specialcarbine"),
	add_wanted_trade(2300,"specialcarbine_mk2"),
	add_wanted_trade(1400,"heavysniper"),
	add_wanted_trade(800,"sniperrifle"),
	add_wanted_trade(600,"marksmanrifle"),
	add_wanted_trade(1300,"marksmanrifle_mk2"),
	add_wanted_trade(3500,"heavysniper_mk2"),
	add_wanted_trade(3000,"compactlauncher"),
	add_wanted_trade(2500,"grenadelauncher"),
	--add_wanted_trade(40,"petrolcan"),
	add_wanted_trade(10,"bottle"),
	add_wanted_trade(2200,"rpg"),
	add_wanted_trade(100,"flare"),
	add_wanted_trade(5000,"minigun"),
	--add_wanted_trade(100,"extinguisher"),
	add_wanted_trade(50,"nightstick"),
	add_wanted_trade(120,"proxmine"),
	add_wanted_trade(200,"stickybomb"),
	add_wanted_trade(50,"hammer"),
	add_wanted_trade(110,"grenade"),
	add_wanted_trade(70,"bzgas"),
	
	add_wanted_trade(25,"water"),
	add_wanted_trade(30,"canfood"),
	add_wanted_trade(40,"fish"),
	add_wanted_trade(15,"gasoline"),
	add_wanted_trade(40,"mre"),
	add_wanted_trade(50,"meat"),
	add_wanted_trade(50,"chemicals"),
	add_wanted_trade(150,"ammo",50),
	add_wanted_trade(50,"engineparts"),
	add_wanted_trade(35,"soda"),
	add_wanted_trade(45,"juice"),
	add_wanted_trade(30,"bandage"),
	add_wanted_trade(150,"medkit"),
	add_wanted_trade(30,"alcohol"),
	add_wanted_trade(60,"weed"),
	add_wanted_trade(60,"pistolammo",30),
	add_wanted_trade(90,"heavyrifleammo",10),
	add_wanted_trade(100,"shotgunammo",20),
	add_wanted_trade(30,"food"),
	add_wanted_trade(40,"cigarettes"),
	add_wanted_trade(15,"scrapmetal"),
	add_wanted_trade(40,"level3asoftplate"),
	add_wanted_trade(70,"level3plates"),
	add_wanted_trade(15,"electronicscrap"),
	add_wanted_trade(30,"industrialelectronicscrap"),
	add_wanted_trade(60,"milspecelectronicscrap"),
	add_wanted_trade(30,"industrialfabrics"),
	add_wanted_trade(60,"milspecfabrics"),
	add_wanted_trade(20,"leadscrap"),
	add_wanted_trade(30,"industrialscrapmetal"),
	add_wanted_trade(60,"milspecmetal"),
	add_wanted_trade(30,"industrialplastic"),
	add_wanted_trade(60,"milspecplastic"),
	add_wanted_trade(10,"scrapplastic"),
	add_wanted_trade(12,"rags"),
	add_wanted_trade(80,"gasmask"),
	add_wanted_trade(250,"tattookey"),
	add_wanted_trade(250,"barberkey"),
	add_wanted_trade(400,"provisionkey"),
	add_wanted_trade(800,"gunstorekey"),
	add_wanted_trade(15,"flaregunammo"),
	add_wanted_trade(200,"bodyarmor"),
	add_wanted_trade(100,"brasscatcher"),
	--add_wanted_trade(20,"casings",50),
	add_wanted_trade(50,"gunpowder"),
	--add_wanted_trade(30,"riflecasings",50),
	add_wanted_trade(80,"radio"),
	add_wanted_trade(20,"aircraftfuel"),
	add_wanted_trade(1000,"sheriffkey"),
	add_wanted_trade(300,"policedocs"),
	add_wanted_trade(75,"painkillers"),
	add_wanted_trade(100,"quest_bag"),
	add_wanted_trade(100,"quest_pouch"),
	add_wanted_trade(100,"quest_ring"),
	add_wanted_trade(200,"quest_id"),
	add_wanted_trade(300,"quest_usb"),
	add_wanted_trade(250,"quest_harddrive"),
	add_wanted_trade(600,"quest_laptop"),
	add_wanted_trade(300,"quest_cellphone"),
	add_wanted_trade(150,"quest_docs"),
	add_wanted_trade(100,"quest_disc"),
	add_wanted_trade(250,"quest_gameconsole"),
	add_wanted_trade(275,"quest_medicalrecords"),
	add_wanted_trade(150,"quest_box"),
	add_wanted_trade(200,"quest_keys"),
	add_wanted_trade(100,"smgammo",50),
	add_wanted_trade(200,"mgammo",50),
	add_wanted_trade(130,"launchergrenade"),
	add_wanted_trade(100,"clothes_marauder"),
	add_wanted_trade(100,"clothes_camouflage"),
	add_wanted_trade(120,"armorplate"),
	add_wanted_trade(150,"clothes_offdutysheriff"),
	add_wanted_trade(150,"cowboyhat"),
	add_wanted_trade(120,"pmccap"),
	add_wanted_trade(130,"tacticalglasses"),
	add_wanted_trade(50,"halfmask"),
	add_wanted_trade(700,"roninmask"),
	add_wanted_trade(30,"tapemask"),
	add_wanted_trade(900,"blackopstacticalhelmet"),
	add_wanted_trade(800,"maraudercombathelmet"),
	add_wanted_trade(600,"specopscommsgear"),
	-- add_wanted_trade(100,"smugglersgarb"),
	-- add_wanted_trade(120,"smugglersshemagh"),
	add_wanted_trade(120,"cheekiheavyhelmet"),
	add_wanted_trade(60,"balaclava"),
	add_wanted_trade(20,"tshirtmask"),
	add_wanted_trade(20,"camocap"),
	add_wanted_trade(1500,"clothes_explorer"),
	add_wanted_trade(1500,"clothes_pmc"),
	add_wanted_trade(20,"clothes_trash"),
	add_wanted_trade(1500,"clothes_combat_desert"),
	add_wanted_trade(1500,"clothes_combat_green"),
	add_wanted_trade(150,"clothes_loner"),
	add_wanted_trade(1500,"clothes_mercenary"),
	add_wanted_trade(130,"clothes_banditgoon"),
	add_wanted_trade(150,"clothes_police"),
	add_wanted_trade(25,"lowcap"),
	add_wanted_trade(1500,"clothes_banditmercenary"),
	add_wanted_trade(600,"clothes_riot"),
	add_wanted_trade(500,"clothes_smugglerslight"),
	add_wanted_trade(900,"clothes_toughguy"),
	add_wanted_trade(100,"clothes_rookie"),
	add_wanted_trade(200,"clothes_breekiscavenger"),
	add_wanted_trade(250,"clothes_combatmarauder"),
	add_wanted_trade(1200,"clothes_mercexperimental"),
	add_wanted_trade(1000,"clothes_merclight"),
	add_wanted_trade(700,"clothes_gunrunner"),
	add_wanted_trade(200,"clothes_smugglers"),
	add_wanted_trade(170,"clothes_scavenger"),
	add_wanted_trade(350,"clothes_banditauthority"),
	add_wanted_trade(400,"clothes_dawn"),
	add_wanted_trade(150,"dawntokens"),
	add_wanted_trade(50,"grip"),
	add_wanted_trade(100,"flashlight_small"),
	add_wanted_trade(130,"flashlight_large"),
	add_wanted_trade(230,"suppressor_1"),
	add_wanted_trade(240,"suppressor_2"),
	add_wanted_trade(250,"suppressor_3"),
	add_wanted_trade(260,"suppressor_4"),
	add_wanted_trade(270,"suppressor_5"),
	add_wanted_trade(160,"scope_1"),
	add_wanted_trade(170,"scope_2"),
	add_wanted_trade(180,"scope_3"),
	add_wanted_trade(200,"scope_advanced"),
	add_wanted_trade(250,"bandits_records"),
	add_wanted_trade(120,"cues"),
	add_wanted_trade(250,"scope_compactholo"),
	add_wanted_trade(150,"muzzlebrake_1"),
	add_wanted_trade(100,"heavybarrel"),
	add_wanted_trade(600,"scope_nightvision"),
	add_wanted_trade(2000,"scope_thermal"),
	add_wanted_trade(200,"backpack"),
	add_wanted_trade(300,"duffelbag"),
	add_wanted_trade(170,"tirerepair"),
	add_wanted_trade(60,"clothes_trucker"),
	add_wanted_trade(200,"clothes_business"),
	add_wanted_trade(80,"clothes_ordinary"),
...
local function generate_trade_list(faction)
	...
	for k,v in pairs(trades.buying) do
		if math.random(1,#trades.buying)<=10 then
			if not blacklist[v.itemforbuying] then
				local approxprice=math.random(math.floor(v.minhowmuch),math.floor(v.maxhowmuch))
				if approxprice>1000 then
					if math.random(1,4)==1 then
						goto addwantedtolist
					end
				elseif approxprice>200 then
				...
				::movearound_addtolist::
				
			else
				--print("wanted item "..v.itemforbuying.." but already selling "..v2[1])
			end
		end
	end
	return list
...
local raids={
	{x=1697.1645507813,y=2611.8725585938,z=45.56494140625,r=150.0*0.5,t=1,maxlives=5,lives=5},
	{x=1697.1645507813,y=2611.8725585938,z=45.56494140625,r=150.0*0.5,t=1,maxlives=5,lives=5},
	--{x=1697.1645507813,y=2611.8725585938,z=45.56494140625,r=150.0,t=1,maxlives=20,lives=20},
	--{x=1697.1645507813,y=2611.8725585938,z=45.56494140625,r=150.0,t=1,maxlives=20,lives=20},
	
	{x=-1094.7305908203,y=4916.3178710938,z=215.40106201172,r=150.0*0.5,t=5,maxlives=5,lives=5},
	{x=-902.81695556641,y=5419.4990234375,z=36.243270874023,r=150.0*0.5,t=5,maxlives=5,lives=5},
	
	{x=449.26019287109,y=-985.76031494141,z=30.689590454102,r=150.0*0.5,t=3,maxlives=5,lives=5},
	{x=449.26019287109,y=-985.76031494141,z=30.689590454102,r=150.0*0.5,t=3,maxlives=5,lives=5},
	
	{x=-2051.8083496094,y=3237.236328125,z=31.501235961914,r=150.0*0.5,t=2,maxlives=5,lives=5},
	
	--{x=568.62316894531,y=-3124.1098632813,z=18.768627166748,r=150.0,t=4,maxlives=20,lives=20},
	{x=568.62316894531,y=0.1098632813,z=18.768627166748,r=150.0*0.5,t=4,maxlives=5,lives=5},
